...
//     this.service.recents(token).subscribe((res: any) => {
//       this.recents = res.recentFiles;
//     });
...
export class LayoutComponent implements OnInit {
  image = "https://img.freepik.com/free-vector/illustration-businessman_53876-5856.jpg?w=740&t=st=1690375137~exp=1690375737~hmac=1cd5ea9bf0c4fc6c1879764613adc63cab934698877969b985086aab91c89287";
  recents$: Observable<any> |null=null;
  ...
  fetch(){
    ...
    this.service.getNavInfo(token).subscribe((res: any) => {
      this.userinfo = res;
    });

    this.recents$ = this.service.recents(token);
  }
  ...
  trackByMethod(index:number,ele:any)
  {
    return ele.version;
  }
}
